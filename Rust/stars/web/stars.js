...
* @param {number} num
*/
export function create_stars(w, h, num) {
    wasm.create_stars(w, h, num);
}

/**
*/
export function render_stars() {
    wasm.render_stars();
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_drawstuff_bdc53652dc4a3bec = function(arg0, arg1, arg2, arg3, arg4) {
        draw_stuff(arg0, arg1, getStringFromWasm0(arg2, arg3), arg4);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('stars_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
